...
$(document).ready(function(){
    ...
    $(".add-scholar").select2({
        ...
        dropdownParent: $("#add_scholarship")
    });
    ...
    $('.requirements').multiSelect({
        selectableHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Select Requirements'>",
        selectionHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Selected Requirements'>",
    ...
    $('.fees').multiSelect({
        selectableHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Select Fees'>",
        selectionHeader: "<input type='text' class='form-control' autocomplete='off' placeholder='Selected Fees'>",
        afterInit: function(ms) {
            var that = this,
                $selectableSearch = that.$selectableUl.prev(),
                $selectionSearch = that.$selectionUl.prev(),
